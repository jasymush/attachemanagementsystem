...
class Config:
    ...
    MAIL_USERNAME = os.environ.get('MAIL_USERNAME') or 'mushjay5@gmail.com'
    ...
    MAIL_PASSWORD = os.environ.get('MAIL_PASSWORD') or 'qufv xtnf wucq tahk'

    # 6. MAIL_DEFAULT_SENDER: This is the email address that will appear as the "From" address.
    MAIL_DEFAULT_SENDER = os.environ.get('MAIL_DEFAULT_SENDER') or 'mushjay5@gmail.com'
    # ---------------------------------------------------------------------
